...
for (const combo of pedido) {
    ...
    <button class="btnRestar" id='restar${combo.id}'>restar</button>
    <p class="contadorCard">Cantidad en tu pedido: <span id='contador${combo.id}'>${combo.cantidad}</span></p>
    <button class="btnSumar" id='sumar${combo.id}'>sumar</button>
